 ...
 */
export type GeoJSON<G extends Geometry | undefined = Geometry, P = GeoJsonProperties> =
	| G
	| Feature<G, P>
...
export type GeoJsonProperties = { [name: string]: any } | undefined;

/**
 * A feature object which contains a geometry and associated properties.
 * https://tools.ietf.org/html/rfc7946#section-3.2
 */
export interface Feature<G extends Geometry | undefined = Geometry, P = GeoJsonProperties> extends GeoJsonObject {
	type: "Feature";
	/**
 ...
 */
export interface FeatureCollection<G extends Geometry | undefined = Geometry, P = GeoJsonProperties> extends GeoJsonObject {
